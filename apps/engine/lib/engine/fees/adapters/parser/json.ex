defmodule Engine.Fees.Adapters.Parser.Json do
  @moduledoc """
  ...
  defp spec_reducer({:ok, %{token: token} = token_fee}, {errors, token_fee_map, spec_index, tx_type}) do
