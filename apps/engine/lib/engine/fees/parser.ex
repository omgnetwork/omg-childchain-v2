defmodule Engine.Fees.Parser do
  ...
  ## Examples
      ...
      iex> Engine.Fees.Parser.merge_specs(
      ...>   %{
      ...>     1 => %{
      ...>       "eth" => %{
      ...>         amount: 1,
  ...
  """
  @spec merge_specs(Server.full_fee_t(), Server.full_fee_t() | nil) :: Server.typed_merged_fee_t()
  def merge_specs(current_specs, nil), do: remove_unused_fields(current_specs)

  def merge_specs(current_specs, previous_specs) do
    current_specs = remove_unused_fields(current_specs)
    previous_specs = remove_unused_fields(previous_specs)
