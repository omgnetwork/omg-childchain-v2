defmodule Engine.Fees.Client do
  @moduledoc """
  ...
  defp get_unparsed_response_body({:ok, %HTTPoison.Response{} = response}),
    do: get_unparsed_response_body(response)

  defp get_unparsed_response_body(%HTTPoison.Response{status_code: 200, body: body}),
    do: {:ok, body}

  defp get_unparsed_response_body(%HTTPoison.Response{body: error}),
