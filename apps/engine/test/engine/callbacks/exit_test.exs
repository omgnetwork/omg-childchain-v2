    ...
    test "marks utxos that are exiting" do
      ...
      exit_events = [
        %{
          ...
          log_index: 1,
          owner:
            <<43, 240, 242, 172, 73, 83, 240, 173, 228, 58, 95, 61, 91, 148, 170, 3, 238, 172,
              173, 157>>,
          root_chain_txhash:
            <<22, 115, 252, 106, 26, 193, 50, 43, 145, 150, 64, 164, 140, 100, 3, 4, 45, 193, 97,
              40, 231, 41, 105, 130, 118, 28, 128, 196, 88, 132, 207, 163>>
        }
      ]
