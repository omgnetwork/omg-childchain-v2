    ...
    test "plasma_framework, tx_hash and authority_address can be set", %{test: test_name} do
      ...
      engine_setup = [
        ...
        engine: [
          ...
          eth_vault: elem(EIP55.encode("0x4e3aeff70f022a6d4cc5947423887e7152826cf7"), 1),
          erc20_vault: elem(EIP55.encode("0x4e3aeff70f022a6d4cc5947423887e7152826cf7"), 1),
          payment_exit_game: elem(EIP55.encode("0x4e3aeff70f022a6d4cc5947423887e7152826cf7"), 1),
