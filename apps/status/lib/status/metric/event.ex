defmodule Status.Metric.Event do
  ...
  @doc """
  Childchain  State mempool transactions
  """
  def name(:pending_transactions), do: "pending_transactions"

  @doc """
  Childchain  State transactions in formed block
  """
