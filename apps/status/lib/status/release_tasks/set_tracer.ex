defmodule Status.ReleaseTasks.SetTracer do
  @moduledoc false
  ...
  def get_sync_threshold() do
    sync_threshold0 = Application.get_env(:spandex_datadog, :sync_threshold)
    sync_threshold = validate_integer(get_env("SYNC_THRESHOLD"), sync_threshold0)
